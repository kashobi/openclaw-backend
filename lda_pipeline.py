...
COMPANY_TICKER_MAP = {
    ...
    # Pharma and medtech subsidiaries and brand entities, so FDA approvals filed under a
    # subsidiary name still map to the public parent. FDA lists the legal applicant, which is
    # often one of these rather than the household parent name.
    "wyeth": "PFE", "pfizer ireland": "PFE", "hospira": "PFE", "pharmacia": "PFE",
    "seagen": "PFE", "array biopharma": "PFE",
    "janssen": "JNJ", "janssen biotech": "JNJ", "janssen pharmaceuticals": "JNJ",
    "actelion": "JNJ", "cilag": "JNJ", "ethicon": "JNJ", "depuy": "JNJ", "abiomed": "JNJ",
    "genentech": "RHHBY", "ventana": "RHHBY", "spark therapeutics": "RHHBY",
    "roche diagnostics": "RHHBY", "roche molecular": "RHHBY",
    "sandoz": "NVS", "advanced accelerator": "NVS", "novartis pharmaceuticals": "NVS",
    "alcon": "ALC",
    "genzyme": "SNY", "sanofi-aventis": "SNY", "sanofi aventis": "SNY", "sanofi pasteur": "SNY",
    "medimmune": "AZN", "alexion": "AZN", "astrazeneca pharmaceuticals": "AZN",
    "glaxosmithkline": "GSK", "glaxo": "GSK", "viiv": "GSK",
    "celgene": "BMY", "juno therapeutics": "BMY", "myokardia": "BMY",
    "kite pharma": "GILD", "immunomedics": "GILD",
    "pharmacyclics": "ABBV", "allergan": "ABBV", "botox": "ABBV",
    "schering": "MRK", "schering-plough": "MRK", "organon": "OGN", "merck sharp": "MRK",
    "cerner": "ORCL",
    "biosense": "JNJ", "mentor worldwide": "JNJ",
    "covidien": "MDT", "minimed": "MDT", "medtronic minimed": "MDT",
    "guidant": "BSX", "cameron health": "BSX",
    "wright medical": "SNN", "smith & nephew": "SNN", "smith and nephew": "SNN",
    "zimmer biomet": "ZBH", "zimmer": "ZBH",
    "baxter": "BAX", "baxalta": "TAK", "takeda": "TAK", "shire": "TAK",
    "teva": "TEVA", "teva pharmaceuticals": "TEVA",
    "bausch": "BHC", "bausch & lomb": "BLCO", "bausch and lomb": "BLCO",
    "hikma": "HKMPF", "viatris": "VTRS", "mylan": "VTRS", "upjohn": "VTRS",
    "catalent": "CTLT", "charles river": "CRL", "iqvia": "IQV",
    "dexcom": "DXCM", "insulet": "PODD", "resmed": "RMD", "hologic": "HOLX",
    "illumina": "ILMN", "grail": "ILMN", "exact sciences": "EXAS", "natera": "NTRA",
    "align technology": "ALGN", "align": "ALGN", "masimo": "MASI",
    "intuitive": "ISRG", "penumbra": "PEN", "inspire medical": "INSP",
    "novocure": "NVCR", "tandem diabetes": "TNDM",
    "regeneron pharmaceuticals": "REGN", "vertex pharmaceuticals": "VRTX",
    "biomarin": "BMRN", "neurocrine": "NBIX", "united therapeutics": "UTHR",
    "jazz pharmaceuticals": "JAZZ", "jazz": "JAZZ", "halozyme": "HALO",
    "incyte": "INCY", "exelixis": "EXEL", "alnylam": "ALNY", "ionis": "IONS",
    "sarepta": "SRPT", "bluebird bio": "BLUE", "beam therapeutics": "BEAM",
    "intellia": "NTLA", "crispr therapeutics": "CRSP",
}
